...
player1_name = Entry(tk, textvariable=player_a, bd=5)
...
def checkForWin():
    if (button1['text'] == "X" and button2['text'] == "X" and button3["text"] == "X" or
        ...
        disableButton()
        tkinter.messagebox.showinfo("Tic-Tac_Toe", player_b)
...
label = Label(tk, text="Player 1:", font="Times 20 bold", bg="white", fg="white", height=1, width=8)
label.grid(row=1, column=0)

label = Label(tk, text="Player 2:", font="Times 20 bold", bg="white", fg="white", height=1, width=8)
